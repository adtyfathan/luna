...
class Create extends Component
{
    ...
    public function createPost()
    {
        ...
        try {
            ...
            $post = Post::create([
                'konten' => $this->konten,
                'author_type' => 'App\Models\Perusahaan',
                'author_id' => $this->perusahaanId,
            ]);
            ...
            return $this->redirect(route('perusahaan.index', $this->perusahaanId), navigate: true);
    ...
    {
        return view('livewire.perusahaan.post.create');
    }
}
