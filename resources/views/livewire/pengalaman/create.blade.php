        ...
        <div class="bg-white rounded-2xl shadow-xl border border-blue-100 overflow-hidden">
            ...
            <form wire:submit="store" class="p-8 space-y-8">
                ...
                <div class="space-y-2 text-black">
                    ...
                    <input type="text" id="namaPerusahaan" wire:model="namaPerusahaan"
                ...
                <div class="space-y-2 text-black">
                    ...
                    <input type="text" id="jabatan" wire:model="jabatan"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 placeholder-gray-400"
                        placeholder="Jabatan anda dalam perusahaan tersebut" required>
                    @error('jabatan')
                        <p class="text-red-500 text-sm mt-1 flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                ...
                <div class="space-y-2 text-black">
                    <label for="tipePekerjaan" class="block text-sm font-semibold text-gray-700">
                        Tipe Pekerjaan
                        <span class="text-red-500">*</span>
                    </label>
                    <Select required wire:model="tipePekerjaan" id="tipePekerjaan" name="tipePekerjaan" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 placeholder-gray-400">
                ...
                <div class="space-y-2 text-black">
                    ...
                    <textarea name="deskripsi" id="deskripsi" wire:model="deskripsi" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 placeholder-gray-400"></textarea>
                    @error('deskripsi')
                        <p class="text-red-500 text-sm mt-1 flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                ...
                <div class="space-y-2 text-black">
                    ...
                    <input type="text" id="lokasi" wire:model="lokasi"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 placeholder-gray-400"
                        placeholder="Lokasi tempat anda bekerja">
                    @error('lokasi')
                        <p class="text-red-500 text-sm mt-1 flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
