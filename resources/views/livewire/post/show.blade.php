<div class="max-w-4xl my-4 mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
    ...
    <div class="flex items-center p-4 border-b border-gray-200">
        <div class="flex-shrink-0">
            @if($post->author->foto_profil)
                <img class="h-12 w-12 rounded-full object-cover" src="{{ asset('storage/' . $post->author->foto_profil) }}"
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="bg-gray-100 rounded-lg px-3 py-2">
                                <a href="{{ route('pengguna', $comment->user->id) }}" wire:navigate class="text-sm font-semibold text-gray-900">{{ $comment->user->name }}</a>
