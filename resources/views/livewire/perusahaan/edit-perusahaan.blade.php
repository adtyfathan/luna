<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-gray-900 mb-4">Edit UMKM Anda!</h1>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <form wire:submit="editCompany" class="space-y-6">
                <!-- Logo/Photo Upload  -->
                <div>
                ...
                <div>
                    ...
                    @error('nama_perusahaan') <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
