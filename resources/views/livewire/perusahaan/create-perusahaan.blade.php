            ...
            <form wire:submit.prevent="createCompany" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="photo-upload" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                            @if($logo)
                            ...
                            @endif
                            <input id="photo-upload" type="file" wire:model="logo" accept="image/*" class="hidden">
                        </label>
                    </div>
                ...
                <div>
                    ...
                    <textarea id="description" wire:model="deskripsi" rows="4"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="city" wire:model="kota" 
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                ...
                <div class="text-center pt-4">
                    <p class="text-sm text-gray-500">
                        Dengan membuat UMKM, Anda menyetujui 
