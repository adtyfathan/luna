<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-gray-900 mb-4">Buat Produk UMKM Anda!</h1>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <form wire:submit.prevent="save" class="space-y-6">
                        ...
                        <label for="logo" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                            @if($gambar)
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-sm text-green-600 font-medium">{{ $gambar->getClientOriginalName() }}</p>
                            ...
                            @else
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="mb-2 text-sm text-gray-500"><span class="font-semibold">Klik untuk upload</span> Gambar Produk</p>
                ...
                <div>
                    ...
                    @error('namaProduk') <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    >
                        <span wire:loading.remove>Tambah Produk</span>
