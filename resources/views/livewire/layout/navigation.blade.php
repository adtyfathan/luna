        ...
        <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('perusahaan.create')" wire:navigate>
                                {{ __('Buat UMKM') }}
                            </x-dropdown-link>
            ...
            @else
                <div class="hidden sm:flex sm:items-center sm:ms-6 gap-6">
                    <a href="{{ route('login') }}" class="text-gray-500 hover:text-gray-700 text-sm font-medium" wire:navigate>
                        Masuk
                    </a>
                    <a href="{{ route('register') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded text-sm font-medium"
                        wire:navigate>
                        Daftar
                    </a>
                </div>
