<div>
    ...
    // dump($latestPengalaman);
                                ...
                                @if ($latestPengalaman)
                                    ...
                                    <div class="flex items-center text-gray-500 my-4">
                                        <img class="h-8 w-8 mr-2 object-cover rounded-full opacity-90" src="{{ asset('images/default-company.png') }}"
                                            alt="company logo">
                                        <span class="text-sm">
                                                            ...
                                                            @else
                                                                <div class="grid grid-cols-2 gap-1 rounded-lg overflow-hidden">
                                                                    @foreach($post->gambarPost->take(4) as $index => $image)
                                                                        <div class="relative">
                                                                            <img src="{{ asset('storage/' . $image->url) }}" class="w-full h-48 object-cover" onclick="openImageModal(this.src)">
