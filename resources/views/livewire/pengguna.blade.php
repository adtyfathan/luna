<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 pt-6">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gradient-to-r from-blue-100 via-pink-100 to-purple-100 shadow-md border border-blue-100 rounded-lg">
            <div class="p-8">
                <!-- Profile Header -->
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                    ...
                    <div class="relative flex-shrink-0">
                        ...
                        @else
                            <div class="h-32 w-32 rounded-full bg-gradient-to-br from-white to-blue-100 flex items-center justify-center shadow-md ring-4 ring-white">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                            <div class="flex-1">
                                <!-- Name and Headline -->
                                <h1 class="text-2xl sm:text-3xl font-bold text-black mb-2 drop-shadow-sm">{{ $user->name }}</h1>
            ...
            @if ($activeTab === 'profil')
                ...
                <div class="lg:col-span-3 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg border border-blue-100 p-6 bg-gradient-to-br from-white to-blue-50/50">
                        ...
                        <p class="text-gray-700 leading-relaxed">{{ $user->keterangan ? $user->keterangan : "Belum ada informasi profil" }}</p>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-blue-100 p-6 bg-gradient-to-br from-white to-blue-50/50">
                    <h3 class="font-bold text-gray-900 mb-4 flex items-center">
                        <div class="h-6 w-6 bg-gradient-to-r from-blue-500 to-blue-600 rounded-md flex items-center justify-center mr-2">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-blue-100 p-6 bg-gradient-to-br from-white to-blue-50/50">
                    <h3 class="font-bold text-gray-900 mb-4 flex items-center">
                        <div class="h-6 w-6 bg-gradient-to-r from-purple-500 to-purple-600 rounded-md flex items-center justify-center mr-2">
                            <svg class="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                            </svg>
                    ...
                    <div class="text-center py-8 text-gray-500">
                        <div class="h-12 w-12 bg-gradient-to-br from-purple-100 to-purple-200 rounded-full flex items-center justify-center mx-auto mb-3">
